...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-[#fbfaf7] text-[#173f45]">
      ...
      <footer className="border-t border-[#dce7e1] px-5 py-8 text-sm text-[#6a8588]"><div className="mx-auto flex max-w-7xl flex-col justify-between gap-4 sm:flex-row"><span className="font-bold text-[#173f45]">raíces<span className="text-[#b8481c]">.</span></span><span>{language === 'ES' ? 'Hecho con cariño desde El Salvador · © 2026' : 'Made with care in El Salvador · © 2026'}</span><span>{language === 'ES' ? 'Español · Términos · Privacidad' : 'English · Terms · Privacy'}</span></div></footer>
    </main>
  )
}

...
const COPY = {
  ES: {
    ...
    errors: {
      ...
      databaseNotConfigured: 'La base de datos no está configurada. Ejecuta: pnpm bootstrap',
  ...
  EN: {
    ...
    errors: {
      ...
      databaseNotConfigured: 'The database is not configured. Run: pnpm bootstrap',
